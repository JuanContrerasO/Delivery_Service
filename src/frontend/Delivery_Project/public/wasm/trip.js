...
var _compute_time = Module['_compute_time'] = makeInvalidEarlyAccess('_compute_time');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['compute_time'] != 'undefined', 'missing Wasm export: compute_time');
  ...
  _compute_time = Module['_compute_time'] = createExportWrapper('compute_time', 2);
